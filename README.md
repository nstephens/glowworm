...
- Simple QR code-based device registration
...
- Image debugging mode with detailed overlays
...
- Accordion-based settings navigation
...
The script will:
1. Download required Docker files (approximately 50KB)
