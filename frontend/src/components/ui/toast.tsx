...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-20 right-6 z-[100] flex max-h-screen w-[calc(100vw-3rem)] flex-col-reverse p-4 sm:w-auto sm:min-w-[360px] sm:max-w-[480px] sm:bottom-auto sm:right-6 sm:top-20 sm:flex-col",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-sm opacity-80 leading-normal mt-1", className)}
    {...props}
  />
))
